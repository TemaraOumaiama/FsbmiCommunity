        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="nav-item">
                <a class="nav-link collapsed" href="#">
                    <i class="fas fa-fw fa-user-Abonnemments"></i>
         ...
         <div id="content" class="content content-full-width">
            ...
            <div class="profile-content">
               ...
               <div class="tab-content p-0">
                  <!-- begin #profile-Abonnemments tab -->
                  <div class="tab-pane fade in active show" id="profile-Abonnemments">
                     <h4 class="m-t-0 m-b-20"> Liste Abonnemments  (14)</h4>
                     <!-- begin row -->
                              ...
                              <div class="media media-xs overflow-visible">
                                 ...
                                 <div class="media-body valign-middle text-right overflow-visible">
                                    <div class="btn-group dropdown">
                                       <a href="javascript:;" class="btn btn-default">Abonnemments</a>
